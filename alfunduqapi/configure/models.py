...
class Staff(models.Model):
    ...
    user = models.OneToOneField(settings.AUTH_USER_MODEL, on_delete=models.SET_NULL, null=True, editable=False)
...
class Room(models.Model):
    ...
    floor = models.ForeignKey('Floor', null=False, blank=True, on_delete=models.CASCADE)
    ...
    def __str__(self):
        return "%s - %s - Rs. %i" % (self.room_no, self.room_type.type_name, self.room_type.rate)
